...
// Package v1alpha1 contains API Schema definitions for the novaedge v1alpha1 API group
// +kubebuilder:object:generate=true
// +groupName=novaedge.io
package v1alpha1
...
var (
	...
	GroupVersion = schema.GroupVersion{Group: "novaedge.io", Version: "v1alpha1"}
